...
import {
  ...
  Hotel, Car, Users, Star, MessageSquare, Settings, Search, Bell
} from 'lucide-react';
        ...
        <div className="p-8 overflow-y-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-10">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead className="bg-gray-50 text-[11px] text-gray-500 uppercase font-bold tracking-wider">
                    <tr><th className="px-5 py-3">User</th><th className="px-5 py-3">Type</th><th className="px-5 py-3">Item</th><th className="px-5 py-3">Date</th><th className="px-5 py-3 text-right">Status</th></tr>
                  </thead>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <table className="w-full text-left">
                <thead className="bg-gray-50 text-[11px] text-gray-500 uppercase font-bold tracking-wider">
                  <tr><th className="px-5 py-3">Hotel Name</th><th className="px-5 py-3">City</th><th className="px-5 py-3">Owner</th><th className="px-5 py-3 text-right">Total Rooms</th></tr>
                </thead>
                <tbody className="divide-y divide-gray-100 text-[13px]">
                  <tr><td className="px-5 py-4">Mountain View Resort</td><td className="px-5 py-4">Skardu</td><td className="px-5 py-4">Bilal Zaman</td><td className="px-5 py-4 text-right">80</td></tr>
                  <tr><td className="px-5 py-4">Deluxe Hunza Hotel</td><td className="px-5 py-4">Hunza</td><td className="px-5 py-4">Noor Ahmed</td><td className="px-5 py-4 text-right">60</td></tr>
                </tbody>
              </table>
            </div>
          </div>
